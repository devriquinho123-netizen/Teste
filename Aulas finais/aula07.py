# ============================================================
# AULA 07 - Convolução com diversas máscaras (bordas e médias)
# ============================================================
# Baseado no arquivo: procimg/aula7/convolucao.py
# (Não havia implementação própria do usuário para esta aula;
#  a "convolucaoGeneralizado.py" do usuário pertence à aula 8/9.)
# ============================================================
