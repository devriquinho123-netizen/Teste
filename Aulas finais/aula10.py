# ==========================================================
# AULA 10 - Abertura e Fechamento (RECONSTRUÇÃO)
# ATENÇÃO: você não tinha uma pasta "aula10" própria.
# As funções aplicarAbertura/aplicarFechamento aparecem dentro de
# minhasAulas/aula11/contorno.py (e se repetem em todas as aulas seguintes).
# Extraí essas funções e montei este arquivo equivalente ao que o
# procimg/aula10 cobre (abertura.py + fechamento.py).
# O hit-or-miss do procimg/aula10 NÃO tem equivalente no seu código
# (ver lista de aulas faltando ao final da entrega).
# ==========================================================

nomeIm = 'jota1.jpg'  # ajuste para a imagem usada nessa aula (ex.: jota1.jpg / jota2.jpg do procimg)
import cv2
import numpy
...
abertura = aplicarAbertura(mascara, pretoBranco, quant)
fechamento = aplicarFechamento(mascara, pretoBranco, quant)

cv2.imshow("imagem Original", imagem)
cv2.imshow("imagem Preto e Branco", pretoBranco)
cv2.imshow("Abertura da imagem", abertura)
cv2.imshow("Fechamento da imagem", fechamento)
cv2.waitKey(0)
