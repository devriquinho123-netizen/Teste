# ============================================================
# AULA 06 - Especificação de Histograma
# ============================================================
# Baseado no arquivo: procimg/aula6/especificar-histograma.py
...
histogramas = [histograma, histogramaNormalizado, histogramaNormalizadoAcumulado, histogramaEqualizado,
               histogramaEspecificado, histogramaEspecificadoNormalizado, histogramaEspecificadoNormalizadoAcumulado,
               nivelCinzaHistogramaEspecificadoNormalizadoAcumulado, mapeamento, histogramaAposEspecificacao]
labels = ["Histograma", "Histograma Normalizado", "Histograma Normalizado Acumulado", "Histograma Equalizado",
          "Histograma Especificado", "Histograma Especificado Normalizado",
          "Histograma Especificado Normalizado Acumulado", "Nível Cinza Histograma Especificado Normalizado Acumulado",
          "Mapeamento", "Histograma Após Especificação"]
