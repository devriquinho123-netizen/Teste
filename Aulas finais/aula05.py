# ============================================================
# AULA 05 - Equalização de Histograma (abordagem por coluna)
# ============================================================
# Baseado no arquivo: procimg/aula5/equalizar-histograma.py
# (Não havia implementação própria do usuário para esta aula.
#  Esta versão evolui a equalização da aula 4, trocando o cálculo
#  ponto a ponto de T^-1 por uma construção de coluna de mapeamento.)
# ============================================================
