...
mascara1 = numpy.array([[-1, -1, -1], [0, 0, 0], [1, 1, 1]])
mascara2 = numpy.array([[-1, 0, 1], [-1, 0, 1], [-1, 0, 1]])

cv2.imshow("Tons de Cinza", resize(cinza))
img1 = convolucionar(cinza, mascara1)
cv2.imshow("Prewitt Horizontal", resize(img1))
img2 = convolucionar(cinza, mascara2)
cv2.imshow("Prewitt Vertical", resize(img2))
img3 = unir(img1, img2)
cv2.imshow("Prewitt Junto", resize(img3))
