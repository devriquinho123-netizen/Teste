...
mascara1 = numpy.array([[-1, -2, -1], [0, 0, 0], [1, 2, 1]])
mascara2 = numpy.array([[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]])

cv2.imshow("Tons de Cinza", resize(cinza))
img1 = convolucionar(cinza, mascara1)
cv2.imshow("Sobel Horizontal", resize(img1))
img2 = convolucionar(cinza, mascara2)
cv2.imshow("Sobel Vertical", resize(img2))
img3 = unir(img1, img2)
cv2.imshow("Sobel Junto", resize(img3))
