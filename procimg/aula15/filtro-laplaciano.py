...
mascara1 = numpy.array([[0, -1, 0], [-1, 4, -1], [0, -1, 0]])
mascara2 = numpy.array([[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]])
mascara3 = numpy.array([[1, -2, 1], [-2, 4, -2], [1, -2, 1]])

cv2.imshow("Tons de Cinza", resize(cinza))
img1 = convolucionar(cinza, mascara1)
cv2.imshow("Laplaciano 1", resize(img1))
img2 = convolucionar(cinza, mascara2)
cv2.imshow("Laplaciano 2", resize(img2))
img3 = convolucionar(cinza, mascara3)
cv2.imshow("Laplaciano 3", resize(img3))
img4 = unir(img1, img2)
img5 = unir(img4, img3)
cv2.imshow("Laplaciano Junto", resize(img5))
