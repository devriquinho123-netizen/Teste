...
imgErodida = fitQtd(1, pretoBranco, masc(13), True)
cv2.imshow("Preto e Branco Erodida 13x13", resize(imgErodida))
cv2.imshow("Preto e Branco Dilatada 13x13", resize(hitQtd(1, imgErodida, masc(13), True)))
