...
imgDilatada = hitQtd(1, pretoBranco, masc(8), False)
cv2.imshow("Dilatada 8x8", resize(imgDilatada))
cv2.imshow("Erodida 8x8", resize(fitQtd(1, imgDilatada, masc(8), False)))
