...
complementar= complementoPretoBranco(esqueleto)

esqueletoSobreposto= unirEsqueleto(pretoBranco, complementar)

cv2.imshow("imagem Original", imagem)
cv2.imshow("imagem Preto e Branco", pretoBranco)
cv2.imshow("Esqueleto da imagem", esqueleto)
cv2.imshow("Esqueleto Sobreposto", esqueletoSobreposto)
cv2.waitKey(0)
