...
"""mascara1= definirMascaraLaplaciano(1)
mascara2= definirMascaraLaplaciano(2)
mascara3= definirMascaraLaplaciano(3)
...
resultadoAdicao= unir2(tomCinza, resultadoMask, k)"""

"""resultado1= aplicaFiltro(mascara1, tomCinza, 1)
resultado2= aplicaFiltro(mascara2, tomCinza, 1)
resultado3= aplicaFiltro(mascara3, tomCinza, 1)
"""
...
"""
"""cv2.imshow("imagem Tons de Cinza", tomCinza)
cv2.imshow("Imagem Borrada", suavizada)
cv2.imshow("Mascara da imagem", resultadoMask)"""

"""resultado1= conectividade4(pretoBranco)
resultado2= conectividade8(pretoBranco)
"""


resultado= esqueletoNovo(pretoBranco)
"""cv2.imshow(f"Imagem com coloraçao distintas 4", resultado1)
cv2.imshow(f"Imagem com coloraçao distintas 8", resultado2)
"""
cv2.imshow(f"Imagem com esqueleto", resultado)
cv2.waitKey(0)
