...
dilatacao1= aplicaDilatacao(mascara, pretoBranco, quant)
dilatacao2= aplicaDilatacao(mascara2, pretoBranco, quant)

#cv2.imshow("tomCinza", tomCinza) 
cv2.imshow("imagem Original", imagem)
cv2.imshow("imagem Preto e Branco", pretoBranco)
#cv2.imshow("Erosao da imagem", erosao)
cv2.imshow("Dilatação da imagem com mascara 5x5", dilatacao1)
cv2.imshow("Dilatação da imagem com mascara 3x3", dilatacao2)
cv2.waitKey(0)
